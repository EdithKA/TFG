...
/// Displays custom thoughts when the player interacts with the object.
/// </summary>
public class InspectInteractable : MonoBehaviour, IInteractable
{
    ...
    /// <summary>
    /// Handles the interaction when the player examines the object.
    /// </summary>
    ...
    /// <summary>
    /// Displays the interaction prompt when the player hovers over the object.
    /// </summary>
    ...
    /// <summary>
    /// Clears the interaction prompt when the player stops hovering.
    /// </summary>
