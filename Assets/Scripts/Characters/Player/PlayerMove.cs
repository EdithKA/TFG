...
public class PlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Actualizamos los par�metros de animaci�n
        setAnimation();
    ...
    void GetInput()
    {
        ...
        else // Restablecer velocidad si NO se est� presionando LeftShift
        {
            speed = playerSpeed;
        ...
        // 2. Manejar el tel�fono
        if (Input.GetMouseButtonDown(1)) // Acercar el tel�fono
        {
            isCloser = true;
        }
        else if (Input.GetMouseButtonUp(1)) // Alejar el tel�fono
        {
            isCloser = false;
        }
    ...
    IEnumerator OpenInventory()
    {
        ...
        // Esperamos un peque�o tiempo para que la transici�n comience
        yield return new WaitForSeconds(0.1f);

        // Luego esperamos a que la animaci�n se est� reproduciendo y termine
